      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col items-center mt-7 mb-5">
          <motion.a
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            href="https://drive.google.com/file/d/1MaVT4TCTVGPHg8T1TbOKfv_NUXQYWG6z/view?usp=sharing"
          ...
          >
            <span className="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white">
              ...
              <span className="absolute top-1/2 right-3 transform -translate-y-1/2"></span>
            </span>
            <span
